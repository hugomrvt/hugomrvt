...
def detect_platform_logo(url):
    u = url.lower()
    if 'loop.genairadar.co' in u:
        return 'Loop', '<img alt="Loop" src="https://www.google.com/s2/favicons?domain=loop.genairadar.co&sz=20" height="20" width="20"/>'
    if 'loop.genairadar.co' in u:
        return 'Loop', '<img alt="Loop" src="https://www.google.com/s2/favicons?domain=loop.genairadar.co&sz=20" height="20" width="20"/>'
    if 'medium.com' in u or 'designsystemscollective.com' in u or 'loop.genairadar.co' in u or 'stories.mrvt.io' in u or 'loop.genairadar.co' in u:
...
def gather_entries():
    ...
    # Loop.genairadar.co
    for loop_url in ("https://loop.genairadar.co/feed",):
